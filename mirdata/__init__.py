...
def initialize(dataset_name, data_home=None, label_type=None, indexes=None, version="default"):
    ...
    return module.Dataset(data_home=data_home, label_type=label_type, indexes=indexes, version=version)
